...
class HsmTrackBar extends HsmControl {
  constructor(panel, dock = HsmDock.fill, pos = 0, thick = 6, color, backgroundColor,
    rect = {}, margin = {}) {
...
class HsmMediaTrackBar extends HsmControl {
  constructor(panel, dock = HsmDock.fill, thick = 6, color, backgroundColor,
    rect = {}, margin = {}) {
    super(panel, dock, rect, margin);
    ...
    this.trackBar = new HsmTrackBar(panel, HsmDock.fill, 0, thick, color, backgroundColor);
  }
  ...
  size() {
    ...
    this.playtime.y = this.y + (this.h - this.playtime.h) / 2 - 1;
...
class HsmVolume extends HsmControl {
  constructor(panel, dock = HsmDock.fill, thick = 6, size = 16, color, backgroundColor,
    rect = {}, margin = {}) {
    super(panel, dock, rect, margin);
